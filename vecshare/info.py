...
INDEX_FILE_PATH ='/home/jared/VecShare/vecshare/index_file.csv'
AR_SIG_PATH = '/home/jared/VecShare/vecshare/ar_sig.txt'
LARGE_EMB_TAG= 'vecshare-large'
SMALL_EMB_TAG= 'vecshare-small'
...
DATASETS_URL = 'https://data.world/datasets/'
